...
export class Convert {
    public static toCapital(json: string): Capital[] {
        return cast(JSON.parse(json), a(r("Capital")));
    }

    public static capitalToJson(value: Capital[]): string {
        return JSON.stringify(uncast(value, a(r("Capital"))), null, 2);
    }
}
